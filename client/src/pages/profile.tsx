  ...
  return (
    <div className="pb-20 px-4 pt-6 max-w-6xl mx-auto">
      <div className="mb-6">
        ...
        <p className="text-muted-foreground">Track your body stats and measurements</p>
      </div>
        ...
        <Card data-testid="card-current-weight">
          ...
          <CardContent>
            {isLoading ? (
              ...
              <>
                <div className="text-3xl font-bold font-mono" data-testid="text-current-weight">
        ...
        <Card data-testid="card-current-bodyfat">
          ...
          <CardContent>
            {isLoading ? (
              ...
              <>
                <div className="text-3xl font-bold font-mono" data-testid="text-current-bodyfat">
