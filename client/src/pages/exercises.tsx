...
const MUSCLE_GROUPS = ["All", "Chest", "Back", "Upper Legs", "Lower Legs", "Shoulders", "Arms", "Core", "Biceps", "Triceps", "Glutes", "Upper Abs", "Lower Abs", "Calves", "Forearms", "Cardio", "Full Body"];
