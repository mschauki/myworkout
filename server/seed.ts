...
const seedExercises = async () => {
  ...
  const exerciseData = [
    ...
    { name: "Front Squat", description: "Squat with barbell on front of shoulders", muscleGroup: "legs", equipment: "barbell", imageUrl: null },
    { name: "Goblet Squat", description: "Squat holding dumbbell or kettlebell at chest", muscleGroup: "legs", equipment: "dumbbell", imageUrl: null },
    ...
    { name: "Walking Lunges", description: "Perform lunges while walking forward", muscleGroup: "legs", equipment: "bodyweight", imageUrl: null },
    { name: "Bulgarian Split Squat", description: "Single-leg squat with rear foot elevated", muscleGroup: "legs", equipment: "bodyweight", imageUrl: null },
    { name: "Calf Raise", description: "Raise heels to stand on toes", muscleGroup: "legs", equipment: "machine", imageUrl: null },
    { name: "Seated Calf Raise", description: "Raise heels while seated for soleus emphasis", muscleGroup: "legs", equipment: "machine", imageUrl: null },
    { name: "Hack Squat", description: "Squat on hack squat machine at angle", muscleGroup: "legs", equipment: "machine", imageUrl: null },
    { name: "Sumo Deadlift", description: "Deadlift with wide stance and toes pointed out", muscleGroup: "legs", equipment: "barbell", imageUrl: null },
    { name: "Step-ups", description: "Step up onto elevated platform", muscleGroup: "legs", equipment: "bodyweight", imageUrl: null },
    { name: "Box Jumps", description: "Jump explosively onto box or platform", muscleGroup: "legs", equipment: "bodyweight", imageUrl: null },
    { name: "Nordic Curls", description: "Lower body forward while kneeling for hamstring work", muscleGroup: "legs", equipment: "bodyweight", imageUrl: null },
    { name: "Glute Bridge", description: "Thrust hips up while lying on back", muscleGroup: "legs", equipment: "bodyweight", imageUrl: null },
    { name: "Hip Thrust", description: "Thrust hips with upper back on bench", muscleGroup: "legs", equipment: "barbell", imageUrl: null },
    { name: "Single-Leg Deadlift", description: "Deadlift on one leg for balance and unilateral work", muscleGroup: "legs", equipment: "dumbbell", imageUrl: null },
    { name: "Pistol Squat", description: "Single-leg squat to full depth", muscleGroup: "legs", equipment: "bodyweight", imageUrl: null },
    { name: "Wall Sit", description: "Hold squat position against wall", muscleGroup: "legs", equipment: "bodyweight", imageUrl: null },
